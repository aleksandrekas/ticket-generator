    ...
    return (
        <div className="lg:w-full  px-4 flex flex-col justify-items-start items-center z-50 container-type-inline-size">
            ...
            <div className="aspect-15/7  w-[clamp(300px,30cqi,500px)] bg-[url('/pattern-ticket.svg')] bg-center bg-cover my-9 flex justify-between items-center container-type-inline-size">
                <div className="w-full h-full flex flex-col border-2 border-amber-700 justify-between items-start container-type-inline-size p-3">
                    ...
                    <div className="w-full h-[45%] container-type-inline-size  flex items-center ">
                        ...
                        <div className=" w-full h-full  container-type-inline-size mx-4 flex flex-col justify-center">
                            <p className="font-bold text-white text-[clamp(10px,1.2cqi,5rem)]">Jonathan Kritoph</p>
                            <div className="w-full flex justify-start items-center">
                                <img className="w-[10%]" src="/icon-github.svg" alt="git_logo" />
                                <p className="text-[#a6a4b9] text-[clamp(1px,2cqi,1rem)]">@aleksandresdsdw</p>
                            </div>
                        </div>
                    </div>
                   
                </div>
                <div className="border-2 border-amber-700 rotate-90 text-[#a6a4b9] text-[clamp(1rem,2cqi,5rem)] text-center ">#01609</div>
            </div>           
        </div>
    )
}    